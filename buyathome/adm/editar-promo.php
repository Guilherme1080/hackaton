  ...
  <table id="produtos-table">
    ...
    <tbody>
      <tr data-id="1">
        ...
        <td><input type="text" value="Nescau 370g"></td>
        <td><input type="number" step="0.01" value="20"></td>
        <td><input type="number" value="2.39"></td>
        <td><button class="save-btn">Salvar</button></td>
      </tr>
      <tr data-id="2">
        <td><img src="../src/img/OIP (6).jpeg" alt="Produto 2" class="thumb"></td>
        <td><input type="text" value="Biscoito Nestlé"></td>
        <td><input type="number" step="0.01" value="25"></td>
        <td><input type="number" value="4.75"></td>
        <td><button class="save-btn">Salvar</button></td>
      </tr>
    </tbody>
  </table>
