  ...
  <table id="produtos-table">
    ...
    <tbody>
      <tr data-id="1">
        ...
        <td><input type="text" value="Chocolate 90g"></td>
        <td><input type="number" step="0.01" value="4"></td>
        <td><button class="save-btn">Salvar</button></td>
      </tr>
      <tr data-id="2">
        <td><img src="../src/img/OIP (2).jpeg" alt="Produto 2" class="thumb"></td>
        <td><input type="text" value="Pasta de Dente"></td>
        <td><input type="number" step="0.01" value="6"></td>
        <td><button class="save-btn">Salvar</button></td>
      </tr>
    </tbody>
  </table>
